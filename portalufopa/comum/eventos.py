...
@permission_content(tipo='ATEvento', permissao='create', login_url='/security/login/')
def create(request):
...
@permission_content(tipo='ATEvento', permissao='workflow', login_url='/security/login/')
